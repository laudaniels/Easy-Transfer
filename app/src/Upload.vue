      ...
      .row
        ...
        .col-sm-5
          ...
          .text-right(v-show='showUploadBtn')
            button#uploadBtn.btn.btn-lg.btn-block.btn-success(@click="$store.dispatch('upload/upload')")
              icon.fa-fw(name="upload")
              |  {{ $root.lang.upload }}
          .text-right(v-show="state === 'uploadError'")
            button#uploadRetryBtn.btn.btn-lg.btn-block.btn-success(@click="$store.dispatch('upload/upload')")
              icon.fa-fw(name="upload")
              |  {{ $root.lang.retry }}
</template>
